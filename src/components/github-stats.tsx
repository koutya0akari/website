...
export function GitHubStats({ username }: GitHubStatsProps) {
  ...
  const intensityColors = [
    "bg-night-muted border-transparent",
    ...
    return (
      <div className="space-y-4 animate-pulse">
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="h-24 rounded-xl bg-night-muted" />
          ))}
        </div>
        <div className="h-48 rounded-xl bg-night-muted" />
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-night-muted">
        ...
        <a
          ...
          className="flex items-center gap-2 rounded-full border border-transparent bg-night-muted px-4 py-2 text-sm text-white/70 transition hover:bg-night-muted"
        >
          View Profile
      ...
      <div className="overflow-x-auto rounded-xl border border-transparent bg-night-muted p-4">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="pointer-events-none absolute bottom-full left-1/2 z-10 mb-2 -translate-x-1/2 opacity-0 transition-opacity group-hover:opacity-100">
                        <div className="whitespace-nowrap rounded-lg bg-night px-2 py-1 text-xs text-white">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {topRepos.map((repo) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group rounded-xl border border-transparent bg-night-muted p-4 transition hover:border-transparent hover:bg-night-muted"
              >
