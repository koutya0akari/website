...
import type { ProjectSummary, ActivityItem, SeminarTheme, LearningTheme, Profile, ProfileDetail } from "@/lib/types";
...
export function SiteSettingsForm() {
  ...
  const [activeTab, setActiveTab] = useState<"projects" | "activities" | "profile">("projects");
