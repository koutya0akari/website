...
管理パネルから数学メモ、メモ、日記、リソース、サイト設定を管理できます。
...
│   ├── diary/              # 公開数学メモページ
│   ├── memo/               # 公開メモページ
│   ├── monthly-diary/      # 公開日記ページ
│   ├── weekly-diary/       # 旧週間日記リダイレクト
│   ├── resources/          # 公開リソースページ
│   ├── about/              # About ページ
│   └── page.tsx            # トップページ
├── components/
...
| 数学メモ管理 | CRUD、検索、フィルター、リッチエディタ |
| メモ管理 | CRUD、検索、フィルター、リッチエディタ |
| 日記管理 | CRUD、リッチエディタ |
| リソース管理 | PDF/外部リンクの管理 |
...
GET    /api/admin/memo           # メモ一覧
POST   /api/admin/memo           # メモ作成
GET    /api/admin/memo/[id]      # メモ詳細
PUT    /api/admin/memo/[id]      # メモ更新
DELETE /api/admin/memo/[id]      # メモ削除

GET    /api/admin/monthly-diary          # 日記一覧
POST   /api/admin/monthly-diary          # 日記作成
GET    /api/admin/monthly-diary/[id]     # 日記詳細
PUT    /api/admin/monthly-diary/[id]     # 日記更新
DELETE /api/admin/monthly-diary/[id]     # 日記削除
...
数学メモ、メモ、日記は同じ `diary` テーブルを使い、`folder` で区別します。
