      ...
      <div className="space-y-4 animate-pulse">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="flex gap-4">
            <div className="h-3 w-3 rounded-full bg-night-muted" />
            <div className="flex-1 space-y-2">
              <div className="h-4 w-24 rounded bg-night-muted" />
              <div className="h-3 w-48 rounded bg-night-muted" />
            </div>
          </div>
        ))}
      </div>
    ...
    <div className="space-y-6">
      ...
      {hasMore && (
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-transparent bg-night-muted py-3 text-sm text-white/60 transition hover:border-transparent hover:bg-night-muted hover:text-white"
        >
          {expanded ? (
            <>
