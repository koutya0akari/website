...
export const FORMAT_MAP: Record<EditorMode, Record<string, FormatOptions>> = {
  ...
  html: {
    ...
    quote: { prefix: "<blockquote>", suffix: "</blockquote>", defaultText: "引用テキスト" },
    ...
    ul: { prefix: "<ul>\n  <li>", suffix: "</li>\n</ul>", defaultText: "リスト項目" },
    ol: { prefix: "<ol>\n  <li>", suffix: "</li>\n</ol>", defaultText: "リスト項目" },
    task: { prefix: '<input type="checkbox"> ', suffix: "", defaultText: "タスク" },
    hr: { prefix: "\n<hr>\n", suffix: "", defaultText: "" },
  },
};
